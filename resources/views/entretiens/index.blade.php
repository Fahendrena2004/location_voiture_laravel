                        ...
                        <flux:table.row>
                            ...
                            <flux:table.cell>
                                <div class="flex gap-2">
                                    <flux:button href="{{ route('entretiens.show', $entretien) }}" wire:navigate icon="eye" size="sm" variant="ghost" />
                                    <flux:button href="{{ route('entretiens.edit', $entretien) }}" wire:navigate icon="pencil" size="sm" variant="ghost" />
