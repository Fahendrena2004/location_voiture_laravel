                        ...
                        <flux:table.row>
                            ...
                            <flux:table.cell>
                                <div class="flex gap-2">
                                    <flux:button href="{{ route('voitures.show', $voiture) }}" wire:navigate icon="eye" size="sm" variant="ghost" />
                                    <flux:button href="{{ route('voitures.edit', $voiture) }}" wire:navigate icon="pencil" size="sm" variant="ghost" />
